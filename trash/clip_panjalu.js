    ...
    axios.post("https://bos.polri.go.id/laporan/buat-laporan/desa", {id: 320708})
    .then(function (response) {
        $('#desa').empty();
        ...
        $.each(response.data, function (id, name) {
            ...
            setTimeout(function(){
                ...
                document.getElementById('kecamatan').value = "PANJALU"
                document.getElementById('desa').value = "Sandingtaman"
